...
export default function Register() {
    ...
    const onSubmit = async (data: RegisterFormData) => {
        try {
            ...
            navigate(
                `/verify-otp?phone=${encodeURIComponent(data.phone_number)}&redirect=${encodeURIComponent(
                    redirectTo
                )}&registration=true`
            );
        } catch (error) {
            ...
            <section className="min-h-screen bg-[#010401] py-12 md:py-20">
                <div className="container mx-auto px-4 max-w-lg">
                    <div className="text-center mb-6">
                        <h1 className="text-3xl font-bold text-white mb-2 mt-4 pt-8 md:pt-0">Create Your Account</h1>
                    ...
                    <div className="bg-theme-card/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-6 shadow-2xl">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-theme-card/50 px-2 text-stone-400">Or register with email</span>
                            </div>
                        </div>
